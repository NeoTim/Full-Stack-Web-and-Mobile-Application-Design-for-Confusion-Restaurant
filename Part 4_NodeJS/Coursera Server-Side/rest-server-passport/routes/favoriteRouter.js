...
.get(Verify.verifyOrdinaryUser, function (req, res, next) {
    ...
    Favorites.find({'postedBy': req.decoded.data._id})    
        .populate('dishes')
        .populate('postedBy')
...
.delete(Verify.verifyOrdinaryUser, function (req, res, next) {
    ...
    Favorites.findOneAndUpdate({'postedBy': req.decoded.data._id}, {$pull: {dishes: req.params.dishId}}, function (err, favorite) {     
        if (err) throw err;
